from PyQt5.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QGridLayout, QLineEdit, QPushButton
...
class CalcView(QMainWindow):
    ...
    def _create_display(self):
        ...
        self.display.setStyleSheet('font size: 25pt')
    ...
    def _create_buttons(self):
        ...
        self.buttons = []
        button_coords = {
            '1': (2, 0),  # второй ряд первая колонка
            '2': (2, 1),
            '3': (2, 2),
            '4': (1, 0),
            '5': (1, 1),
        ...
        for t_btn, coord in button_coords.items():
            ...
            if t_btn == '=':
                q_btn.setFixedSize(130, 235)
            else:
                q_btn.setFixedSize(130, 110)
            q_btn.setStyleSheet('font-size: 25pt; color: grey;')
